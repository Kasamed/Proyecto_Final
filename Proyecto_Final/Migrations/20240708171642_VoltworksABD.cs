...
{
    /// <inheritdoc />
    public partial class VoltworksABD : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Comprador", x => x.Id_comprador);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id_venta = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DiaVenta = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetalleVenta", x => x.Id_detalleventa);
                    table.ForeignKey(
                        name: "FK_DetalleVenta_Comprador_Id_comprador",
                        column: x => x.Id_comprador,
                        principalTable: "Comprador",
                        principalColumn: "Id_comprador",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetalleVenta_Venta_Id_venta",
                        column: x => x.Id_venta,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetalleVenta_Id_comprador",
                table: "DetalleVenta",
                column: "Id_comprador");
